...
xvfb-run python run_gt.py --input /mnt/sdb/tejan/code/sayan_code/slangpy-ml/inputs/texture.jpg --output /mnt/sdb/tejan/code/sayan_code/slangpy-ml/outputs/groundtruth/texture/gt$mipmap_level_float.png --resolution 512 --mipmap_level=$mipmap_level_float