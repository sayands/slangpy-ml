...
# xvfb-run python main.py --mode inference --mipmap_level=6.0 --output /mnt/sdb/tejan/code/sayan_code/slangpy-ml/outputs/checkerboard/output6.0.png --resolution 512