...
do
    ...
    xvfb-run python main.py --mode inference --mipmap_level=$mipmap_level_float --output /mnt/sdb/tejan/code/sayan_code/slangpy-ml/outputs/output$mipmap_level_float.png --resolution 512
done
