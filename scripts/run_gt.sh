...
mipmap_level_float=0.0
xvfb-run -a python run_gt.py --input /mnt/sdb/tejan/code/sayan_code/slangpy-ml/inputs/earth.jpg --output /mnt/sdb/tejan/code/sayan_code/slangpy-ml/outputs/groundtruth/earth/gt$mipmap_level_float.png --resolution 8192 --mipmap_level=$mipmap_level_float